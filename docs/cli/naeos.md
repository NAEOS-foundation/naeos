...
NAEOS CLI - Declarative Engineering Runtime
...
* [naeos benchmark](naeos_benchmark.md)	 - Run pipeline benchmarks
* [naeos broker](naeos_broker.md)	 - Message broker management
* [naeos build](naeos_build.md)	 - Build artifacts from a specification
* [naeos cicd](naeos_cicd.md)	 - Generate CI/CD pipeline configuration
...
* [naeos docgen](naeos_docgen.md)	 - Generate documentation from specification
* [naeos docs](naeos_docs.md)	 - Generate project documentation
...
* [naeos inspect](naeos_inspect.md)	 - Inspect the NAEOS pipeline result
...
* [naeos monitor](naeos_monitor.md)	 - Start monitoring server with Prometheus metrics
...
* [naeos ws](naeos_ws.md)	 - Start WebSocket server for real-time updates
