...
Manage industry-specific project profiles

### Synopsis

List, search, and apply industry-specific project profiles.
...
* [naeos profile apply](naeos_profile_apply.md)	 - Generate a spec file from a profile
