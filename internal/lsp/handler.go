...
func (h *Handler) lookupDocumentation(word string) string {
	docs := map[string]string{
		...
		"architecture":   "**architecture**\nArchitecture pattern and principles.\n\nPatterns: `layered`, `clean`, `hexagonal`, `microkernel`, `event-driven`, `cqrs`, `monolith`, `monolithic`, `microservices`, `serverless`",
		...
		"name":           "**name**\nIdentifier name.",
		"pattern":        "**pattern**\nArchitecture pattern.\n\nValues: `layered`, `clean`, `hexagonal`, `microkernel`, `event-driven`, `cqrs`, `monolith`, `monolithic`, `microservices`, `serverless`",
